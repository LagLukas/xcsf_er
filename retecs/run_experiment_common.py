...
from retecs import agents
from retecs import reward
import retecs
from retecs import scenarios
import stats
...
def exp_run_industrial_datasets(iteration, datasets=['paintcontrol', 'iofrol', 'gsdtsr']):
    ags = [
        lambda: (XCSF_ER(2000, [0, 1], 6), retecs.preprocess_xcs, reward.tcfail),
